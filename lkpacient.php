...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>'.$row['status'].'</td>
      <td><p><a href="delzapis.php?id_zapis='.$row['id_zapis'].'" class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Удалить заявку</a></p></td>
    </tr>';
      }
